...
import 'package:login_with_bloc_api/modules/user/domain/repositories/i_user_repository.dart';
...
class UserRepository implements IUserRepository {
  ...
  @override
  Future<User> getUserLoginAndPassword(String login, String password) async {
    try {
